...
typedef struct {
   ...
   uint32_t focusGlow;          // wider, translucent ring drawn outside focusBorder - the console has no
                                // blur, so a second faint ring is what makes the selection read as a glow
